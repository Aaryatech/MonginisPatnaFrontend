...
<div class="right">
	<div class="priceBox">
		<h2 class="inrbox" id="INR" style="font-size: 25px;">INR - ${(sprRate*specialCake.spMinwt)}</h2>
			...
			function() {
				$.getJSON('${findAddOnRate}', {
					...
					var totalFlavourAddonRate= wt*flavourAdonRate;
					 ...
					 var a=parseFloat(totalCakeRate+totalFlavourAddonRate)
					...
					// alert("mrpBaseRate is :"+mrpBaseRate);
					  ...
					  //var grandTotal=parseFloat(totalCakeRate+totalFlavourAddonRate);
					    ...
					    $('#price').html(totalCakeRate);document.getElementById("sp_calc_price").value=totalCakeRate;
