			...
			//	alert("selectedStockOption"+selectedStockOption);
				...
				//	alert(data);
					$.each(data, function(key, item) {
						...
						tr.append($('<td class="col-md-1"> <input type=text min=0 style=width:80px;   onchange= updateStockDiff('+ item.id + ','+curStock+')  id= damagedStock'+ item.id+' name=damagedStock'+item.id+' value = '+item.damagedStock+ '><input type="hidden" id="currStk'+item.id+'" value='+curStock+'  /></td>'));
					}
