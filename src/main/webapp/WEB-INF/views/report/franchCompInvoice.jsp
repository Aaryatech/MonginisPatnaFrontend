...
<body>
	...
	<table width="250" border="0" cellspacing="0" cellpadding="0"
		...
		<tbody>
			<tr>
				<td colspan="2" align="center" style="padding: 0px;"><span>BILL
						OF SUPPLY</span></td>
			</tr>
			<tr>
				<td colspan="2" align="center"
					style="padding: 0px; border-top: 1px solid #E7E7E7;"><span><b>${billList[0].frName}</b><br />
      ...
      <td colspan="2" align="center" style="padding:1px; border-bottom:1px solid #E7E7E7;"><p class="style2" ><b>${billList[0].frName}</b><br /><span style="font-size: 10px; font-family: Arial;">(The Monginis Cake Shop)</span></p>
			...
			<tr>
				<td colspan="2" align="center"
					style="padding: 2px; font-family: Arial; border-bottom: 1px solid #E7E7E7; font-size: 9px;"><span>${billList[0].frAddress}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="2">
						<tbody>
							<tr>
								...
								<td align="left" style="font-size: 10px;">${billList[0].invoiceNo}
								</td>
								<fmt:parseDate pattern="yyyy-MM-dd"
									value="${billList[0].billDate}" var="dateparsed" />
								<td style="font-size: 10px;"><fmt:formatDate
										pattern="dd-MM-yyyy" value="${dateparsed}" /></td>
							</tr>
							<tr>
												...
												<tr>
													...
													<td align="right"><span style="font-size: 11px">
															<fmt:formatNumber type="number" maxFractionDigits="2"
																minFractionDigits="2"
																value=" ${billList.qty*billList.mrp}" />
													</span></td>
												</tr>
											</c:forEach>
											<tr>
												...
												<td align="right"><span class="style5"><strong><c:choose>
																<c:when test="${billType eq 'R'}">
																	<fmt:formatNumber type="number" maxFractionDigits="2"
																		minFractionDigits="2"
																		value="${billList[0].discountAmt}" />
																</c:when>
																<c:otherwise>
																	<fmt:formatNumber type="number" maxFractionDigits="2"
																		minFractionDigits="2"
																		value="${billList[0].intBillAmt}" />
																</c:otherwise>
															</c:choose> </strong></span></td>
											</tr>
											<c:if
												test="${billList[0].discountPer gt 0 or billList[0].intDiscAmt gt 0}">
												<tr>
													<td colspan="2" align="right"><span class="style5"><strong>Discount
																<fmt:formatNumber type="number" maxFractionDigits="2"
																	minFractionDigits="2"
																	value="${billList[0].discountPer}" />% :
														</strong></span></td>
													<td colspan="2" align="right"><span class="style5"><strong><fmt:formatNumber
																	type="number" maxFractionDigits="2"
																	minFractionDigits="2" value="${billList[0].intDiscAmt}" /></strong></span></td>
												</tr>
											</c:if>
											<tr>
												<td colspan="2" align="right"><span class="style7">Bill
														Total:</span></td>
												<td align="right"><span class="style7"><c:choose>
															<c:when test="${billType eq 'R'}">
																<fmt:formatNumber type="number" maxFractionDigits="2"
																	minFractionDigits="2"
																	value="${billList[0].discountAmt-billList[0].intDiscAmt}" />
															</c:when>
															<c:otherwise>
																<fmt:formatNumber type="number" maxFractionDigits="2"
																	minFractionDigits="2" value="${billList[0].intBillAmt}" />
															</c:otherwise>
														</c:choose></span></td>
											</tr>
										</tbody>
