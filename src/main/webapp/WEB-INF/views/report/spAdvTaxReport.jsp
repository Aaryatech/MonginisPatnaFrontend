				...
				$.getJSON('${getSpAdvTaxReport}', {
					...
					$.each(data, function(key, spTax) {
						...
						tr.append($('<td class="col-md-2"></td>').html(spTax.spHsncd));
 						...
 						tr.append($('<td class="col-md-1" style="text-align:right"></td>').html(spTax.baseMrp.toFixed(2)));
						tr.append($('<td class="col-md-1" style="text-align:right"></td>').html(spTax.tax1));
						tr.append($('<td class="col-md-1" style="text-align:right"></td>').html(spTax.tax2));
						tr.append($('<td class="col-md-1" style="text-align:right"></td>').html(spTax.tax1Amt));
						tr.append($('<td class="col-md-1" style="text-align:right"></td>').html(spTax.tax2Amt));
						tr.append($('<td class="col-md-1" style="text-align:right"></td>').html(spTax.total));
						tr.append($('<td class="col-md-1" style="text-align:right"></td>').html(spTax.spAdvance));
						tr.append($('<td class="col-md-1" style="text-align:right"></td>').html(spTax.rmAmount));
