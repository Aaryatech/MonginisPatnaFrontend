								...
								<div id="examples" class="snap-scrolling-example">
									<div id="content-1" class="horizontal-images">
										<div class="multi_menu">
											<ul>
												<li onclick="setItemList();subCatForSrch(0)"  ><a href="#" class="scroll_menu">All</a></li>
												<c:forEach items="${subCatList}" var="subCat">

													<li onclick="selectBySubCatId(${subCat.subCatId});subCatForSrch(${subCat.subCatId})"><a href="#" class="scroll_menu">${subCat.subCatName}</a></li>
												</c:forEach>
